...
class Search extends React.Component {
  ...
  render () {
    const {
      size, select, selectOptions, selectProps, style, keyword, placeholder,
    }
       = this.props
    ...
    return (
      <Input.Group compact size={size} className={styles.search} style={style}>
        ...
        <Input ref="searchInput" size={size} onChange={this.handleInputChange} onPressEnter={this.handleSearch} placeholder={placeholder} defaultValue={keyword} />
        <Button size={size} type="primary" onClick={this.handleSearch}>Search</Button>
